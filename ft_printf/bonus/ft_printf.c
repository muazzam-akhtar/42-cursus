...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/04 11:49:12 by makhtar           #+#    #+#             */
/*   Updated: 2021/11/04 11:49:12 by makhtar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	parse_hub(char *format, va_list argptr, t_flags *flags)
{
	while (*format)
	{
		if (*format == '%')
		{
			++format;
			parse_flags1(&format, flags);
			parse_precisions(&format, flags);
