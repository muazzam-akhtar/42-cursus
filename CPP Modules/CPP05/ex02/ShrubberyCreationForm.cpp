...
/*   Updated: 2022/06/21 14:57:33 by makhtar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{ std::cout << BLUE << "Shrubbery Creation Form Default Constructor called" << std::endl; }

ShrubberyCreationForm::ShrubberyCreationForm(const std::string &target)
: Form("ShrubberyCreationForm", 145, 137) , _target(target)
{ std::cout << BLUE << "Shrubbery Creation Form Standard Constructor called" << std::endl; }
...
void	ShrubberyCreationForm::execute(const Bureaucrat &executor) const
{
	...
	myfile << "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" << std::endl;
	myfile.close();
	std::cout << YELLOW << "Created the shrug in " << this->_target << "_shrubbery" << std::endl << std::endl;
}
